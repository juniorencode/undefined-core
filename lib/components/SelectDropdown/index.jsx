  ...
  return (
    <>
      {options.length > 0 && isOpen && (
        <div
          className={cn(
            'listbox absolute top-full z-20 my-2 w-full border rounded-lg shadow-box-top bg-secondary-200 dark:bg-secondary-800 border-secondary-300 dark:border-secondary-700 dark:shadow-neutral-900',
            {
              'shadow-box-bottom':
