  ...
  return (
    ...
    >
      <div className="relative">
        <input
          className="p-2.5 pr-12 w-full h-12 sm:text-sm border rounded-lg outline-none focus:ring-4 focus:ring-opacity-40 checked:focus:ring-opacity-40 focus:dark:ring-opacity-40 checked:focus:dark:ring-opacity-40 transition-all text-secondary-900 dark:text-white bg-secondary-50 dark:bg-secondary-700 dark:placeholder-secondary-400 border-secondary-300 dark:border-secondary-600 focus:border-primary-600 dark:focus:border-primary-500 focus:ring-primary-600 dark:focus:ring-primary-500"
          ref={domRef}
          role="textbox"
          id={domId}
