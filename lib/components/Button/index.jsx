...
export const Button = props => {
  ...
  const initialStyles =
    'flex gap-2 items-center justify-center h-10 px-5 py-2.5 text-nowrap font-medium text-sm rounded-lg focus:ring-4 focus:ring-opacity-30 checked:focus:ring-opacity-40 focus:dark:ring-opacity-50 checked:focus:dark:ring-opacity-50 outline-none transition-all';

  const optionsColor = {
    default:
      'text-white bg-primary-600 dark:bg-primary-700 hover:bg-primary-700 dark:hover:bg-primary-800 focus:ring-primary-600 dark:focus:ring-primary-800 disabled:bg-primary-300 dark:disabled:bg-primary-400',
