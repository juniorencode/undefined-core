  ...
  return (
    <Card>
      ...
      <Table
        ...
        dndFunc={dndFunc}
      />
      <div className="flex items-center justify-center sm:justify-between m-4 h-10 dark:text-white">
        <p className="hidden sm:block">{`${pagination.from} al ${pagination.to} de ${pagination.total}`}</p>
        <Pagination
