      ...
      {title && (
        <h1
          className={cn('text-xs font-bold tracking-widest uppercase', {
            'p-4 rounded-t-lg dark:bg-opacity-50 text-white dark:text-secondary-300 bg-primary-600 dark:bg-primary-800':
              box,
            'py-2 text-primary-600 dark:text-primary-500': !box
          })}
        >
          {title}
        </h1>
